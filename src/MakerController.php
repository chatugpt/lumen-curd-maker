...
class MakerController extends Controller
{
	...
	public function index(Request $request, $table = '')
	{
		...
		foreach ($getTables as $table)
		{
			...
			$routeName .= $this->getRoute($table, $controllerName)."\r\n";
		}
	...
	public function getRoute($table, $controllerName)
	{
		/**
		...
		$str = '';
		$str .= "\$router->get('$table', '{$controllerName}Controller@index');\r\n";
		$str .= "\$router->get('$table/create', '{$controllerName}Controller@edit');\r\n";
		$str .= "\$router->get('$table/{id}/edit', '{$controllerName}Controller@edit');\r\n";
		$str .= "\$router->get('$table/{id}', '{$controllerName}Controller@show');\r\n";
		$str .= "\$router->post('$table/{id}/delete', '{$controllerName}Controller@destroy');\r\n";
		$str .= "\$router->post('$table/{id}', '{$controllerName}Controller@store');\r\n";
		$str .= "\$router->post('$table', '{$controllerName}Controller@store');\r\n";
